...
<main class="section"><div class="container article" style="max-width:820px;">
  <div class="article-review">Published by <a href="https://www.drconnorrobertson.com/">Dr. Connor Robertson</a>, real estate entrepreneur and investor &middot; Tax review by <a href="https://www.aetaxadvisors.com/">AE Tax Advisors Tax Team</a> &middot; Reviewed {UPDATED} &middot; <a href="../editorial-policy/index.html">Editorial policy</a></div>
...
def postprocess_html() -> int:
    ...
    for path in ROOT.rglob("*.html"):
        ...
        if path.parent.parent.name == "blog" and 'class="article"' in text and "Published by" not in text:
            text = re.sub(r'<div class="meta">(.*?)</div>', r'<div class="meta">\1 &middot; Published by <a href="https://www.drconnorrobertson.com/">Dr. Connor Robertson</a> &middot; Tax review by <a href="https://www.aetaxadvisors.com/">AE Tax Advisors Tax Team</a> &middot; <a href="../../editorial-policy/index.html">Editorial policy</a></div>', text, count=1, flags=re.S)
